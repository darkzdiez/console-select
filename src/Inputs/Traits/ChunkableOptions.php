<?php
namespace AporteWeb\Console\Inputs\Traits;

use AporteWeb\Console\Inputs\Exceptions\IndexOutOfRange;


/**
 * Trait ChunkableOptions
 * @package AporteWeb\Console\Inputs\Traits
...
trait ChunkableOptions
{
     ...
     * @param int $index
     * @return array
     * @throws AporteWeb\Console\Inputs\Exceptions\IndexOutOfRange
     */
